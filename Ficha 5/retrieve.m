...
function [holiday_type_sim] = get_holiday_type_similarities()
    ...
    holiday_type_sim.similarities = [
        % Active Bathing City Education Language Recreation Skiing Wandering
           ...
           0.1      1.0   0.2   0.1     0.3         0.8      0.7    0.5      % Bathing
           0.9      0.8   1.0   0.8     0.6         0.6      0.2    0.6      % City
           0.7      0.3   0.7   1.0     0.9         0.8      0.1    0.2      % Education
           0.5      0.1   0.8   0.9     1.0         0.2      0.0    0.4      % Language
           0.8      0.1   0.4   0.6     0.3         1.0      0.1    0.7      % Recreation
           0.9      0.5   0.1   0.2     0.3         0.7      1.0    0.7      % Skiing
           0.7      0.2   0.7   0.4     0.4         0.8      0.4    1.0      % Wandering
    ];
end
...
function [res] = calculate_haversine_distance(latlon1, latlon2)
    ...
    res = distance / 40075; % 40075 is the earth circunference
end
